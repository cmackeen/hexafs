...
for i, data_element in enumerate(data_elements):
	...
	pic_list[element_index]='https://cmackeen.github.io/assets/img/'+str(data_element)+'.png'
	print(element_index)

for i in range(len(pic_list)):
	if pic_list[i]==0:
		pic_list[i]="https://cmackeen.github.io/assets/specnotfound.png"
	else:
		pass
...
<div>
    ...
    <i>T<sub>long</sub></i> = @countsraw </font>
                <img source=https://cmackeen.github.io/assets/img/Zr.png"@img</img>
                </div>
